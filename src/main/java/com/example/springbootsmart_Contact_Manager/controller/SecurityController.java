...
public class SecurityController {
    ...
    public String createPayment(@RequestBody Map<String, Object> data) throws RazorpayException {
        ...
        RazorpayClient razorpayClient = new RazorpayClient("rzp_test_ikSxuKRBygmGpy", "K3MoaQk9NumTo9ZBhrgkANUB");
        JSONObject options = new JSONObject();
        options.put("amount", amt * 1000);
        options.put("currency", "INR");
        options.put("receipt", "txn_852145");
